...
#[tauri::command]
pub async fn rename_thread_file(path: &str, new_name: &str) -> Result<String, String> {
...
#[tauri::command]
pub async fn read_thread_file(window: Window, path: &str, event_id: &str) -> Result<(), String> {
...
#[tauri::command]
pub async fn append_thread_content(path: &str, content: &str) -> Result<(), String> {
